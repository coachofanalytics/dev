...
#Comment to push at least one change.
...
class Role(models.Model):
    ...
    can_view_reports = models.BooleanField(default=False, help_text='Can view system reports')
...
class UserProfile(models.Model):
    ...
    gdpr_consent_ip = models.GenericIPAddressField(
        null=True,
        blank=True,
    ...
    def __str__(self):
        ...
        # Historical behavior for older tests and display — show possessive
