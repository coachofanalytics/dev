...
class UserGroupsModelTest(TestCase):
    ...
    def test_usergroup_creation(self):
        """Test UserGroups object is created correctly"""
        self.assertEqual(self.group.is_active, True)
        self.assertEqual(self.group.is_featured, False)

    def test_usergroup_str(self):
        """Test string representation"""
        self.assertEqual(str(self.group), f"UserGroup {self.group.id}")
