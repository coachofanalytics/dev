...
urlpatterns = [
    ...
    path('tracker/delete/<int:pk>/', views.Tracker_delete,name='account-Tracker_delete'),
    path('tracker/detail/<int:pk>/', views.Tracker_detail,name='account-Tracker_detail'),
]