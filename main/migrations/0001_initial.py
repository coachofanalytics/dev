# Generated by Django 5.2.11 on 2026-04-03 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('press', 'Press Release'), ('embassy', 'Embassy & Government News'), ('community', 'Community Update'), ('other', 'Other News')], default='other', max_length=50)),
                ('link', models.URLField(blank=True, null=True)),
                ('published_date', models.DateField(auto_now_add=True)),
                ('updated_date', models.DateField(auto_now=True)),
                ('is_event', models.BooleanField(default=False)),
                ('image', models.ImageField(blank=True, null=True, upload_to='news_images/')),
                ('author', models.CharField(default='DC48K News Team', max_length=150)),
                ('excerpt', models.TextField(blank=True, help_text='Short summary for news lists', max_length=500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('background_image', models.URLField(help_text='Poster background image URL')),
                ('colors', models.JSONField(default=list, help_text='Example: ["purple", "green", "pink", "yellow"]')),
                ('tags', models.JSONField(default=list, help_text='Example: ["afrobeats", "amapiano", "2026", "phantom"]')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('consultation_type', models.CharField(blank=True, choices=[('Legal & Immigration', 'Legal & Immigration'), ('Documentation', 'Documentation'), ('Property & Estate', 'Property & Estate'), ('Other', 'Other')], max_length=50, null=True)),
                ('preferred_language', models.CharField(blank=True, choices=[('English', 'English'), ('Swahili', 'Swahili'), ('French', 'French'), ('Spanish', 'Spanish'), ('Other', 'Other')], max_length=50, null=True)),
                ('location', models.CharField(blank=True, help_text="Client's location/country", max_length=200, null=True)),
                ('urgency', models.CharField(blank=True, choices=[('Not Urgent', 'Not Urgent'), ('Moderately Urgent', 'Moderately Urgent (within 3-5 days)'), ('Very Urgent', 'Very Urgent (within 24-48 hours)'), ('Emergency', 'Emergency (immediate assistance needed)')], max_length=50, null=True)),
