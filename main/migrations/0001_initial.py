# Generated by Django 5.2.11 on 2026-05-18 20:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('DRAFT', 'DRAFT'), ('GENERATED', 'GENERATED'), ('SENT', 'SENT'), ('SIGNED', 'SIGNED'), ('EXECUTED', 'EXECUTED')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('contract_document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='main.contractdocument')),
            ],
        ),
        migrations.CreateModel(
            name='ContractEvent',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('contract_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='main.contractpackage')),
            ],
        ),
        migrations.AddField(
            model_name='contractdocument',
            name='contract_package',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='main.contractpackage'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placement_fee', models.DecimalField(decimal_places=2, max_digits=12)),
                ('start_date', models.DateField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('contract_package', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.contractpackage')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='signatures', to='main.contractdocument')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('contract_template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='main.contracttemplate')),
            ],
        ),
        migrations.AddField(
            model_name='contractdocument',
            name='contract_template_version',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.contracttemplateversion'),
        ),
        migrations.CreateModel(
