...
admin.site.register(MedicalResourceInquiry)
...
class ExpertInquiryAdmin(admin.ModelAdmin):
    list_display = [
        'full_name', 'email', 'priority_colored', 'sla_status_colored',
        'assigned_to', 'interested_plan', 'created_at',
        'response_time_display', 'days_old', 'status_colored', 'is_contacted'
    ]
    list_filter = ['is_contacted', 'assigned_to', 'escalated', 'created_at', 'interested_plan']
    search_fields = ['full_name', 'email', 'question', 'notes']
    readonly_fields = [
        'created_at', 'updated_at', 'priority_display',
        'days_old_display', 'sla_deadline_display', 'response_time_display', 'escalated_display'
    ]
    list_editable = ['is_contacted']
    actions = ['mark_as_contacted', 'add_urgent_note', 'assign_to_me', 'escalate_selected']
    ...
    fieldsets = (
        ...
        ('SLA & Assignment', {
            'fields': ('assigned_to', 'sla_deadline', 'first_response_time', 'escalated', 'escalated_to'),
        }),
        ('Status', {
