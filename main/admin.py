...
# ============================================
# NOTE: Communities app was merged into main app, but these models 
# were not added to main/models.py. Commenting out to prevent ImportError.
# TODO: Either restore these models or create them if still needed.
# 
# from .models import (
#     CommunityMember,
#     DirectoryProfile,
...
# ============================================
# NOTE: MembershipRegistration model not found in any app
# TODO: Either create this model or remove this registration if not needed
#
