...
urlpatterns = [
    ...
    # path('history',views.history, name ='history'),  # View does not exist
    ...
    # path('gethelp/', views.gethelp_list, name='gethelp'),  # View does not exist
    # path('gethelp/<int:pk>/update/', views.gethelp_update, name='gethelp_update'),  # View does not exist
    # path('create_gethelp/', views.gethelp_create, name='create_gethelp'),  # View does not exist
    # path('gethelp/<int:pk>/delete/', views.gethelp_delete, name='gethelp_delete'),  # View does not exist
    # path('governance_list/', views.governance_list, name='governance_list'),  # View does not exist
    # path('governance/<int:pk>/update/',views.governance_update , name='governance_update'),  # View does not exist
    # path('create_governance/', views.governance_create, name='create_governance'),  # View does not exist
    # path('governance/<int:pk>/delete/', views.governance_delete, name='governance_delete'),  # View does not exist
    # path('donation',views.organization_list_view, name ='donationorganisation_list'),  # View does not exist
    # path('ourhistory',views.ourhistory, name ='ourhistory'),  # View does not exist
    # path('contact_us',views.contact_us, name ='contact_us'),  # View does not exist
