...
from main.views import registration_update,membershirp_registration_delete,membershipplan_update,delete_membershipplan,membershipplan_detail,news_update,ContactMessage_create,ContactMessage_update,ContactMessage_delete,ContactMessage_detail
