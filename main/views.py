...
def request_mentorship(request):
    """Render and handle the mentorship request form."""
    if request.method == 'POST':
...
def ai_course_discovery(request):
    ...
    harvard_courses = [
        ...
        {"title": "CS50's AI with Python", "university": "Harvard University", "platform": "edX", "duration": "7 Weeks", "url": "https://www.edx.org/course/cs50s-introducation-to-artificial-intelligence-with-python", "is_free": True},
    ]
    ...
    youtube_courses = [
        ...
        {"title": "Machine Learning Full Course", "university": "Stanford (Andrew Ng)", "platform": "Youtube", "duration": "Self-paced", "url": "https://www.youtube.com/watch?v=jGwoUgTS7I", "is_free": True},
    ]
