...
STATIC_URL = "/static/"
STATICFILES_DIRS = [
    # Django automatically finds static files in app directories when apps are in INSTALLED_APPS
    # No project-level static directory exists, so this list is empty
]
