...
class ExpertInquiry(models.Model):
    ...
    def auto_assign(self):
        ...
        ExpertInquiry.objects.filter(pk=self.pk).update(assigned_to=assigned_agent)
...
class Membership_plan(models.Model):
    name = models.CharField(max_length=100, null=False, blank=False)
    price = models.CharField(max_length=50, null=False, blan)
...
class Member_Registration(models.Model):
    ...
    membership_plan = models.ForeignKey(MembershipPlan, on_delete=models.CASCADE, null=False, blank=False)
