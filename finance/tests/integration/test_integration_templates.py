# finance/tests/integration/test_integration_templates.py
from django.test import TestCase
from django.urls import reverse
from finance.models import OverBoughtSold

class OverBoughtSoldTemplateIntegrationTests(TestCase):
    def setUp(self):
        self.url = reverse("finance:overboughtsold_list")

    def test_header_and_columns_present(self):
    ...
    def test_row_cells_render_for_record(self):
