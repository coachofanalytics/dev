...
from django.test import SimpleTestCase
from django.urls import reverse, resolve
from finance.views import Default_Payment_Fees_list

class DefaultPaymentFeesURLTest(SimpleTestCase):

    def test_default_payment_fees_list_url_resolves(self):
        """Test if 'Default_Payment_Fees_list' URL resolves correctly"""
        url = reverse('Default_Payment_Fees_list')
