...
class OverBoughtSoldModelTest(TestCase):
    ...
    def test_ordering(self):
        ...
        stock2 = OverBoughtSold.objects.create(
            ...
            rank="Mid Performer",
            profit_margins=18.4,
            created_at=timezone.now() + timezone.timedelta(seconds=10),  # Later timestamp
        ...
        self.assertEqual(stocks[1], self.stock)  # The first stock should be GOOG and second should be AAPL
