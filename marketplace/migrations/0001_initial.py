        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount_seeking",
                    models.DecimalField(
                        decimal_places=2, help_text="Total amount seeking USD", max_digits=12
                    ),
                ),
                (
                    "minimum_investment",
                    models.DecimalField(
                        decimal_places=2, help_text="Min investment USD", max_digits=12
                    ),
                ),
                (
                    "equity_percentage",
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("open", "Open"), ("closed", "Closed"), ("funded", "Funded")],
                        default="open",
                        max_length=20,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Amount seeking in USD",
                        max_digits=12,
                        null=True,
                    ),
                ),
                ...
                (
                    "business_plan",
                    models.FileField(blank=True, null=True, upload_to="business_documents/plans/"),
                ),
                (
                    "pitch_deck",
                    models.FileField(
                        blank=True, null=True, upload_to="business_documents/pitch_decks/"
                    ),
                ),
                (
                    "financial_statements",
                    models.FileField(
                        blank=True, null=True, upload_to="business_documents/financials/"
                    ),
                ),
