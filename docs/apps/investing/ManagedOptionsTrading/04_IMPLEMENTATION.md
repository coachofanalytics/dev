...
|------|--------|--------|----------------|--------|
| Nov 9, 2025 | **Phase 5 Automation Upgrade** - Auto-approve top-ranked suggestions, 3-hour client SLA auto-approval, staff alerts | Move toward hands-off execution and trader oversight-only workflow | `models.py`, `services/position_ranking_service.py`, `services/batch_approval_service.py`, `services/notification_service.py`, `management/commands/auto_approve_top_positions.py`, `management/commands/process_batch_approvals.py`, `templates/investing/managed/investment_dashboard.html`, `templates/investing/staff/top_5_recommended_section.html`, `views_legacy.py`, `views/managed_trading/batches.py`, `migrations/0019_add_auto_approval_fields.py`, `migrations/0020_add_auto_flags_to_suggested_position.py` | ✅ Complete |
| Nov 9, 2025 | **Trader Confirmation & Auto Metrics** - Added “Mark Entered” workflow, auto-approval performance dashboard, SMS/WhatsApp alerts | Keep human desk in the loop while proving automation win-rate to big-ticket clients | `models.py`, `services/managed_trading_service.py`, `services/position_ranking_service.py`, `services/notification_service.py`, `views/managed_trading/positions.py`, `views/managed_trading/batches.py`, `management/commands/process_batch_approvals.py`, `templates/investing/managed/position_detail.html`, `templates/investing/staff/top_5_recommended_section.html`, `urls_managed_trading.py`, `migrations/0021_add_position_entry_fields.py`, `docs/apps/investing/ManagedOptionsTrading/05_TESTING.md` | ✅ Complete |
| Nov 10, 2025 | **UW Impact Instrumentation** - Added Unusual Whales usage snapshot, Schwab onboarding runbook, plan-alignment scorecard, Twilio test playbook, stale queue pruning + rating filter | Provide data to justify API spend and prep broker automation | `services/position_ranking_service.py`, `views/managed_trading/position_suggestions.py`, `templates/investing/staff/top_5_recommended_section.html`, `docs/operations/brokers/charles_schwab_onboarding.md`, `docs/operations/runbooks/twilio_alert_testing.md`, `docs/apps/investing/ManagedOptionsTrading/06_PLAN_ALIGNMENT.md` | ✅ Complete |
| Nov 10, 2025 | **Pricing Tiers 2025** - Documented Balanced/Elite plans while grandfathering $420 sleeve | Equip sales with upgrade paths and UW cost controls | `docs/apps/investing/ManagedOptionsTrading/feature_guides/PRICING_TIERS_2025.md` | ✅ Complete |
| Nov 8, 2025 | **Phase 5 URL Consolidation** - Routed managed options under `/managed/` prefix, added analytics + broker sync endpoints | Clean namespace, align with implementation plan, simplify routing | `urls_managed_trading.py`, `urls.py` | ✅ Complete |
