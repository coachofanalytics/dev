...
# Import auth modules
from core.domain.authenticator.auth import get_user, validate_user_access
...
async def get_all_users(
    ...
    try:
        ...
        if not users:
            raise RecordNotFoundError("No users found in the database")
        ...
        if not result:
            raise RecordNotFoundError("No valid users found in the database")
